        ...
        <form class="form-horizontal" action="{{ route('sellers.update', $seller->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Delhivery Pickup') }}" id="delhivery_pickup_location" name="delhivery_pickup_location" class="form-control" value="{{ $seller->delhivery_pickup_location }}">
                    </div>
                </div>
            </div>
