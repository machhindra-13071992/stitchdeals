							...
							<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
								<tr>
									<td class="td" bgcolor="#ffffff" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
											<tr>
												<td class="p30-15" style="padding: 20px 30px 40px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:10px; line-height:20px; text-align:center; padding-bottom:10px;">Customer Name : {{ $array['customerName'] }}</td>
														</tr>
														<tr>
															<td class="center  pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:10px; line-height:20px; text-align:center; color:#2e57ae; padding-bottom:10px;">Customer Email : {{ $array['customerEmail'] }}</td>
														</tr>
														<tr>
															<td class="center  pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:10px; line-height:20px; text-align:center; color:#2e57ae; padding-bottom:10px;">Subject : {{ $array['contactSubject'] }}</td>
														</tr>
														<tr>
															<td class="center  pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:10px; line-height:20px; text-align:center; color:#2e57ae; padding-bottom:10px;">Message : {{ $array['content'] }}</td>
														</tr>
													</table>
												</td>
											</tr>
