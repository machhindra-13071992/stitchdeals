...
<head>
    ...
    <script src="{{ my_asset('plugins/datatables/media/js/dataTables.buttons.min.js')}}"></script>
    <script src="{{ my_asset('plugins/datatables/media/js/buttons.flash.min.js')}}"></script>
    <script src="{{ my_asset('plugins/datatables/media/js/jszip.min.js')}}"></script>
    <script src="{{ my_asset('plugins/datatables/media/js/pdfmake.min.js')}}"></script>
    <script src="{{ my_asset('plugins/datatables/media/js/vfs_fonts.js')}}"></script>
    <script src="{{ my_asset('plugins/datatables/media/js/buttons.html5.min.js')}}"></script>
