                ...
                <div class="col-lg-9">
                    <div class="main-content">
                        ...
                        <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-box bg-white mt-4">
                                <div class="form-box-title px-3 py-2">
                                    {{ translate('Delhivery Warehouse Info')}}
                                </div>
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Warehouse Name')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="{{ translate('warehouse Name')}}" name="pickup_warehouse_name" value="{{ isset($shop->pickup_warehouse_name)?$shop->pickup_warehouse_name:$user->name }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Warehouse Address')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="{{ translate('Address')}}" name="pickup_address" value="{{ isset($shop->pickup_address) && $shop->pickup_address != "" ?$shop->pickup_address:$user->address }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Warehouse Phone')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="{{ translate('pickup_phone')}}" name="pickup_phone" value="{{ isset($shop->pickup_phone) && $shop->pickup_phone != "" ?$shop->pickup_phone:$user->phone }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Warehouse Email')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="{{ translate('pickup_email')}}" name="pickup_email" value="{{ isset($shop->pickup_email) && $shop->pickup_email != "" ?$shop->pickup_email:$user->email }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Warehouse City')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="{{ translate('pickup_city')}}" name="pickup_city" value="{{ isset($shop->pickup_city) && $shop->pickup_city != "" ?$shop->pickup_city:$user->city }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Warehouse Country')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="{{ translate('pickup_country')}}" name="pickup_country" value="{{ isset($shop->pickup_country) && $shop->pickup_country != "" ?$shop->pickup_country:$user->country }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Warehouse pickup_pin')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="{{ translate('pickup_pin')}}" name="pickup_pin" value="{{ isset($shop->pickup_pin) && $shop->pickup_pin != "" ?$shop->pickup_pin:$user->postal_code }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
