                        ...
                        <form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-2">
                                            <label>{{translate('Select Sizes')}}</label>
                                        </div>
                						<div class="col-lg-10">
                						    @php
                					...
                					<div class="size-group-conatiner" id="size-options">
                					    @if(!$size_Array == null)
                					        ...
                					        @foreach($size_Array as $key => $option)
                							    ...
                							    <div class="row mt-3" data="{{$name}}">
                        					        <label class="col-lg-2 control-label">{{$size_name[0]}} (Inches)</label>
                        					        <div class="col-lg-2">
                        					            <input type="number" class="form-control" name="{{$name}}[]" id="" value="{{$option->values[0]}}" placeholder="S">
                        					        </div>
                        					        <div class="col-lg-2">
                        					            <input type="number" class="form-control" name="{{$name}}[]" id="" value="{{$option->values[1]}}" placeholder="M">
                        					        </div>
                        					        <div class="col-lg-2">
                        					            <input type="number" class="form-control" name="{{$name}}[]" id="" value="{{$option->values[2]}}" placeholder="L">
                        					        </div>
                        					        <div class="col-lg-2">
                        					            <input type="number" class="form-control" name="{{$name}}[]" id="" value="{{$option->values[3]}}" placeholder="XL">
                        					        </div>
                        					   </div>
                							@endforeach
