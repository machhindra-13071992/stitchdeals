                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-10">
                							<select class="form-control demo-select2-size" name="size_id[]" id="size_id" placeholder="{{ translate('Choose product sizes') }}" multiple>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="closeModal()" data-dismiss="modal">{{ translate('Confirm')}}</button>
                </div>
            </div>
        </div>
    </div>
