...
<link type="text/css" href="{{ my_asset('frontend/scroll_slider/scrollslider.css') }}" rel="stylesheet">
...
<link type="text/css" href="{{ my_asset('frontend/css_updated/vendor/vendor.min.css') }}" rel="stylesheet" media="all">
<link type="text/css" href="{{ my_asset('frontend/css_updated/plugins/plugins.min.css') }}" rel="stylesheet" media="all">
<link type="text/css" href="{{ my_asset('frontend/css_updated/style.min.css') }}" rel="stylesheet" media="all">
...
<script src="{{ my_asset('frontend/js/vendor/vendor.min.js') }}"></script>
<script src="{{ my_asset('frontend/js/plugins/plugins.min.js') }}"></script>
<script src="{{ my_asset('frontend/js/main2.js') }}"></script>
...
<script src="{{ my_asset('frontend/scroll_slider/scrollslider.js') }}"></script>
<script>
...
<script>
	...
	function updatesideNavCart() {
		$.post('{{ route('cart.nav_side_cart') }}', {_token:'{{ csrf_token() }}'}, function(data){
    ...
    function show_purchase_order_tracking_details(order_id)
    {
        ...
        $.post('{{ route('purchase_order_tracking.details') }}', { _token : '{{ @csrf_token() }}', order_id : order_id}, function(data){
     ...
     function scroll_slider(productId,flag){
            ...
            if(flag == 0){   
                $('#best_selling_product'+productId).empty();
                 setTimeout(function(){ $.post('{{ route('home.section.scroll_sliders') }}', {_token:'{{ csrf_token() }}','product_id':productId}, function(data){
                    $(".scrollSlider").empty();
                    $(".scrollSlider").hide();
                    $(".mystyleimg").show();
