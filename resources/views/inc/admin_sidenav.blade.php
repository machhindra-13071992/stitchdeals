                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['psizes.index', 'psizes.create', 'psizes.edit'])}}">
                                        <a class="nav-link" href="{{route('psizes.index')}}">{{translate('Sizes')}}</a>
                                    </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['seller_pickup_points.index'])}}">
                                    <a class="nav-link" href="{{route('seller_pickup_points.index')}}">{{translate('Seller WareHouse Pick-up Point')}}</a>
                                </li>
