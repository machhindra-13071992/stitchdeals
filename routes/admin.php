...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::resource('seller_pickup_points','SellerPickupPointController');
	Route::get('/seller_pickup_points/destroy/{id}', 'SellerPickupPointController@destroy')->name('seller_pickup_points.destroy');
	...
	Route::resource('psizes','PsizeController');
	Route::post('/psizes/status', 'PsizeController@updateStatus')->name('psizes.status');
	Route::get('/psizes/destroy/{id}', 'PsizeController@destroy')->name('psizes.destroy');
});
