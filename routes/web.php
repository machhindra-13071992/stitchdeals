...
Route::get('/password/reset', 'HomeController@resetPassword')->name('password.request');
...
Route::post('/contact/send_email','HomeController@savecontacts')->name('contact.send_email');
...
Route::post('/home/section/scroll_sliders', 'HomeController@load_scroll_sliders')->name('home.section.scroll_sliders');
...
Route::post('/cart/nav-cart-sidebar', 'CartController@updateNavSideCart')->name('cart.nav_side_cart');
...
Route::post('/checkout/check_pincode_delhivery', 'CheckoutController@check_pincode_delhivery')->name('checkout.check_pincode_delhivery');
Route::get('/express_delhivery_order_tracking_cron',['as'=>'express_delhivery_order_tracking_cron','uses'=>'DelhiveryAPIController@express_delhivery_order_tracking_cron']);
//Paypal START
...
Route::group(['middleware' => ['user', 'verified','unbanned']], function(){
	...
	Route::post('/purchase_order_tracking/details', 'PurchaseHistoryController@purchase_order_tracking_details')->name('purchase_order_tracking.details');
