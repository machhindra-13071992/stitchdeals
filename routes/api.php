...
Route::prefix('v1/auth')->group(function () {
    ...
    Route::middleware('auth:api')->group(function () {
        ...
        Route::get('password/reset', 'Api\PasswordResetController@create');
    });
});
...
Route::prefix('v1')->group(function () {
    ...
    Route::post('user/shipping/create','Api\UserController@userShippingCreate')->name('auth:api');
    Route::get('user/shipping/address/{id}','Api\UserController@getShippingAddress')->name('auth:api');
    
    Route::get('user/shipping/delete/{id}','Api\UserController@deleteShippingAddress')->name('auth:api');
