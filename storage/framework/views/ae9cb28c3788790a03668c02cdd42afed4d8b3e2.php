                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <input type="text" class="hidden-field" name="category_id" id="category_id" value="" required="required">
                                            <input type="hidden" name="subcategory_id" id="subcategory_id" value="" required="required">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-10">
                							<select class="form-control demo-select2-size" name="size_id[]" id="size_id" placeholder="<?php echo e(translate('Choose product sizes')); ?>" multiple>
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3" name="purchase_price" placeholder="<?php echo e(translate('Purchase Price')); ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                ...
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" min="0" step="0.01" value="0" class="form-control mb-3" name="flat_shipping_cost" placeholder="<?php echo e(translate('Flat Rate Cost')); ?>">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" min="0" step="0.01" value="0" class="form-control mb-3" name="free_shipping_cost" value="0" disabled placeholder="<?php echo e(translate('Flat Rate Cost')); ?>">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="closeModal()" data-dismiss="modal"><?php echo e(translate('Confirm')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo e(my_asset('frontend/js/select2.min.js')); ?>"></script>
    <script type="text/javascript">
        ...
        sizeSelect.on("select2:select", function(event) {
            ...
            var options = '<div class="row mt-3" data="'+name+'"><label class="col-lg-2 control-label">'+optionText+' (Inches)</label><div class="col-lg-2"><input type="number" class="form-control" name="'+name+'[]" id="" value="" placeholder="S"></div><div class="col-lg-2"><input type="number" class="form-control" name="'+name+'[]" id="" value="" placeholder="M"></div><div class="col-lg-2"><input type="number" class="form-control" name="'+name+'[]" id="" value="" placeholder="L"></div><div class="col-lg-2"><input type="number" class="form-control" name="'+name+'[]" id="" value="" placeholder="XL"></div></div>';
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\stitchdeal\resources\views/frontend/seller/product_upload.blade.php ENDPATH**/ ?>